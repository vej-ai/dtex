...
**simpl.E** ("simple extract") is an open-source, self-hosted Python
...
simpl.E requires Python 3.11+. It installs both a CLI (`simple-e`) and an
importable library (`import simple_e`).

## Usage

```sh
simple-e run -c meta_ads
```
