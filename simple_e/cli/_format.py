"""Human-readable output helpers for the ``simple-e`` CLI.

The CLI is a thin shell over the engine; these functions turn the engine's
result objects (:class:`~simple_e.types.RunResult`,
:class:`~simple_e.types.StateRecord`) and discovery objects into aligned,
...
from simple_e.types import RunResult, RunStatus, StreamStatus
